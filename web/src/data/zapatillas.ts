...
const _rawZapatillas: Zapatilla[] = [
  ...
  // ───────────────────────────────────────────────
  {
    ...
    links_compra: [
      ...
      { tienda: "amazon_es", url: "https://www.amazon.es/s?k=puma+mb+04", precio_actual: 125, disponible: true, tiene_afiliado: false, ultima_verificacion: "2026-05-13" },
    ],
  },
  ...
  // ───────────────────────────────────────────────
  {
    ...
    año_lanzamiento: 2022,
    genero: "unisex",
    tecnologia_clave: ["Nitrofoam", "Pebax plate"],
    peso_real_g: 305,
    altura: "mid",
    horma: "normal",
    drop_mm: 7,
    ...
    material_superior: "mesh",
    puntuaciones: {
      traccion: 7, amortiguacion: 7, respuesta: 9,
      soporte_lateral: 7, estabilidad: 7, peso_score: 9,
      durabilidad_outdoor: 5, ventilacion: 7,
    },
    categoria_principal: "responsive",
    tags: ["responsive", "nitrofoam", "guards", "descuento"],
    ideal_para: {
      posiciones: ["base", "escolta", "alero"],
      peso_jugador_kg: [60, 90],
      estilos: ["explosivo", "equilibrado", "tirador"],
    ...
    no_recomendada_para: { posiciones: ["pivot"], estilos: ["potente"] },
    resumen: "La mejor zapatilla que Puma ha hecho para baloncesto de alto rendimiento. Nitrofoam + placa Pebax devuelve energía de forma brutal. La sorpresa inesperada del mercado cuando salió, ahora a mitad de precio.",
    pros: [
      "Respuesta/energía excepcional con placa Pebax",
      "Muy ligera para su cushion",
      "Buena estabilidad para perfil bajo",
      "Precio actual muy competitivo",
    ],
    contras: [
      "Durabilidad outdoor limitada",
      "Tracción no al nivel de Nike/Adidas top",
      "Soporte de tobillo ajustado",
    ],
    veredicto: "Para bases y escoltas explosivos que quieren máxima respuesta sin pagar 150€. Una de las joyas escondidas del mercado.",
    imagen_principal: "https://d3pnpe87i1fkwu.cloudfront.net/IMG/019157-puma-all-pro-nitro-379300_01_585x585.png",
    imagenes: [],
    fuentes: [],
    ultima_actualizacion: "2026-05-15",
    precio_msrp_eur: 130,
    links_compra: [
      { tienda: "amazon_es", url: "https://www.amazon.es/s?k=puma+all+pro+nitro+basketball", precio_actual: 70, disponible: true, tiene_afiliado: false, ultima_verificacion: "2026-05-15" },
      { tienda: "zalando_es", url: "https://www.zalando.es/buscar/?q=puma+all+pro+nitro", precio_actual: 75, disponible: true, tiene_afiliado: false, ultima_verificacion: "2026-05-15" },
    ],
  },
  ...
  // ───────────────────────────────────────────────
  {
    ...
    precio_msrp_eur: 120,
    links_compra: [
      { tienda: "amazon_es", url: "https://www.amazon.es/s?k=puma+mb05+basketball", precio_actual: 115, disponible: true, tiene_afiliado: false, ultima_verificacion: "2026-05-15" },
      { tienda: "zalando_es", url: "https://www.zalando.es/buscar/?q=puma+mb05", precio_actual: 120, disponible: true, tiene_afiliado: false, ultima_verificacion: "2026-05-15" },
    ],
  },
