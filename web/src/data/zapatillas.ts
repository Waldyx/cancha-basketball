...
const _rawZapatillas: Zapatilla[] = [
...

  {
    ...
    veredicto: "La Jordan mas italiana. No es la mas tecnica ni la mas historica en cancha, pero si la mas elegante de toda la saga. 5.1/10 en performance — su valor esta en el craftsmanship y en ser la unica Jordan hecha en Europa.",
    es_retro: true,
  ...
  // R-42. REEBOK KAMIKAZE I (1994) — Shawn Kemp
  {
    ...
    veredicto: "6.3/10 en rendimiento para pívots de 1994 — soporte y cushion sólidos. Shawn Kemp era la fuerza bruta del baloncesto de los 90 y la Kamikaze I lo refleja perfectamente. Para fans de los Sonics o del juego interior explosivo, es una pieza imprescindible.",
  ...
  // R-45. NIKE AIR ZOOM FLIGHT 95 (1995) — Jason Kidd
  {
    ...
    material_superior: "synthetic",
    puntuaciones: {
      traccion: 7, amortiguacion: 9, respuesta: 8, soporte_lateral: 9,
      estabilidad: 8, peso_score: 5, durabilidad_outdoor: 5, ventilacion: 6,
    },
    categoria_principal: "balanced",
    ...
    veredicto: "7.1/10 en rendimiento retro — una de las mejores relaciones calidad-precio del mercado retro de Nike. El Zoom Air del talón la diferencia de retros sin tecnología de cushion real. Para jugadores de guards que quieren algo distinto a los Air Jordan clásicos.",
  ...
  // R-46. ADIDAS EQT BASKETBALL 93 (1993)
  {
    ...
    material_superior: "leather",
    puntuaciones: {
      traccion: 7, amortiguacion: 8, respuesta: 8, soporte_lateral: 9,
    ...
    veredicto: "6.8/10 en rendimiento retro — el Torsion Bar y el cuero high-top hacen de la EQT Basketball una opción funcional para indoor casual. El diseño es el mejor argumento: minimalismo 90s que ningún modelo actual ha replicado. Para coleccionistas de Adidas retro, es una pieza imprescindible.",
  ...
  // R-47. REEBOK BLAST (1990)
  {
    ...
    material_superior: "leather",
    puntuaciones: {
      traccion: 6, amortiguacion: 8, respuesta: 7, soporte_lateral: 9,
      estabilidad: 9, peso_score: 4, durabilidad_outdoor: 4, ventilacion: 4,
    },
    categoria_principal: "cushion-focused",
    ...
    veredicto: "6.4/10 en rendimiento retro — la Reebok Blast es para coleccionistas de la era pre-Iverson de Reebok. Funcional para indoor casual a pesar de la edad. Para jugadores que quieren el retro Reebok más auténtico posible más allá de la Question Mid.",
