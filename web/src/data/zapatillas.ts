...
const _rawZapatillas: Zapatilla[] = [
  ...
  // R-05. AIR JORDAN 11 (1995) — patent leather, Space Jam
  {
    ...
    veredicto: "La única Jordan retro con la que todavía podrías jugar un pickup y no quedar en ridículo técnico. 6.3/10 performance pero culturalmente es la más codiciada del mercado.",
...

  {
    ...
    veredicto: "La Jordan más amada entre coleccionistas. Jugable, icónica, con herencia directa al parqué de 1991. 5.8/10 en performance — superada por modelos modernos pero insustituible en cultura.",
    es_retro: true,
