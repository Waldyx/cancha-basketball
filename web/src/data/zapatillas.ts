...
const _rawZapatillas: Zapatilla[] = [
  ...
  // R-43. CONVERSE PRO LEATHER (1976)
  {
    ...
    veredicto: "4.0/10 en rendimiento para 2026 — tecnología de los 70s sin cushion ni soporte biomecánico. Su valor es histórico: la zapatilla de la generación pre-Jordan que definió el baloncesto moderno. Magic, Bird y Dr. J la convirtieron en una pieza de museo.",
  ...
  // R-46. ADIDAS EQT BASKETBALL 93 (1993)
  {
    ...
    material_superior: "leather",
    puntuaciones: {
      traccion: 7, amortiguacion: 6, respuesta: 6, soporte_lateral: 8,
  ...
  // R-47. REEBOK BLAST (1990)
  {
    ...
    puntuaciones: {
      ...
      estabilidad: 7, peso_score: 4, durabilidad_outdoor: 4, ventilacion: 4,
    },
    categoria_principal: "cushion-focused",
  ...
  // R-48. NIKE HYPERDUNK 2008 — Kobe, Juegos Olímpicos Pekín
  {
    ...
    material_superior: "synthetic",
    puntuaciones: {
      traccion: 8, amortiguacion: 7, respuesta: 8, soporte_lateral: 7,
      estabilidad: 7, peso_score: 6, durabilidad_outdoor: 5, ventilacion: 6,
    },
    categoria_principal: "balanced",
  ...
  // R-49. CONVERSE LARRY JOHNSON ALL STAR (1993) — Charlotte Hornets
  {
    ...
    material_superior: "leather",
    puntuaciones: {
      traccion: 7, amortiguacion: 6, respuesta: 5, soporte_lateral: 8,
      estabilidad: 8, peso_score: 4, durabilidad_outdoor: 5, ventilacion: 4,
    },
    categoria_principal: "balanced",
